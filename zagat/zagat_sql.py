...
def get_top_cities(query, database = "zagat_adjusted.db"):
    '''
...
def get_top_cuisines(query, database = "zagat_raw.db"):
    '''
...
def star_reviews(query, database = "zagat_raw.db"):
    '''
...
def price_ratings(query, database = "zagat_raw.db"):
    '''
...
def all_cuisines(query, database = "zagat_adjusted.db"):
    '''
...
def special_cuisine(cuisine, database = "zagat_adjusted.db"):
    '''
